...
GET /get-product-restaurants-category/:id – получить продукты ресторана в определённой категории.

GET /get-product-restaurants/:id – получить все продукты ресторана.
