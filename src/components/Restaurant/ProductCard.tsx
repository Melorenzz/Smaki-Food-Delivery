        ...
        <div className='bg-white-col p-[20px] flex items-center gap-[20px] rounded-[36px]'>
            ...
            <div className='h-full w-full flex flex-col'>
                <div className='flex flex-col gap-[8px]'>
                    ...
                    <h3 className='line-clamp-2 font-bold text-[20px] leading-6'>{product.name}</h3>
                    <p className='line-clamp-7 text-dark-gray leading-5 text-[14px]'>{product.description}</p>
                </div>
